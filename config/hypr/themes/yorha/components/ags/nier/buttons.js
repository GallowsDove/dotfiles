...
export const NierButton = ({
  ...
  const setHoverState = async (self, hovered) => {
    const continueHover = hovered
      ? await passedOnHover(self).catch((e) => {
          console.log(e);
          return false;
        })
      : await passedOnHoverLost(self).catch((e) => {
          console.log(e);
          return false;
        });
          ...
          setup: (self) =>
            Utils.timeout(1, () => {
              ...
              self.connect("enter-notify-event", (self) => {
                setHoverState(self, true).catch((e) => {
                  console.log(e);
                });
              });
              self.connect("leave-notify-event", (self) => {
                setHoverState(self, false).catch((e) => {
                  console.log(e);
                });
              });
