...
const cancelSelection = () => {
  Utils.timeout(0, () => System.exit(1));
};

const finishSelection = (geometry) => {
  print(geometry);
  Utils.timeout(0, () => System.exit(0));
};
      ...
      setup: (self) =>
        Utils.timeout(1, () => {
          ...
          self.connect("button-release-event", (self, event) => {
            ...
            Utils.timeout(10, () => {
              finishSelection(`${round(min(anchor_x1.value, anchor_x2.value))},${round(min(anchor_y1.value, anchor_y2.value))} ${abs(round(anchor_x2.value-anchor_x1.value))+1}x${abs(round(anchor_y2.value-anchor_y1.value))+1}`);
            });
          });
