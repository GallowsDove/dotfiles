...
export const settings_title_top = 80*scale;
export const settings_title_bottom = 40*scale;

export const workspace_workspaces = 10;

export const top_spacing = 20*scale;
export const top_icon_size = 30*scale;

export const nier_border_size = 99*scale;
