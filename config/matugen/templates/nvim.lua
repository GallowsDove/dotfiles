...
hi("StatusLineTerm",   { fg = palette.fg, bg = palette.color0 })
hi("StatusLineTermNC", { fg = palette.color8, bg = palette.color0 })
hi("WinSeparator", { fg = palette.color8, bg = palette.bg })
hi("VertSplit",    { fg = palette.color8, bg = palette.bg })
hi("WinBar",       { fg = palette.fg, bg = palette.color0 })
hi("WinBarNC",     { fg = palette.color8, bg = palette.color0 })
...
hi("lualine_x_normal", { fg = palette.fg, bg = palette.bg })
hi("lualine_y_normal", { fg = palette.fg, bg = palette.color0 })
hi("lualine_z_normal", { fg = palette.bg, bg = palette.color4, bold = true })
hi("lualine_a_insert", { fg = palette.bg, bg = palette.color2, bold = true })
hi("lualine_b_insert", { fg = palette.fg, bg = palette.color0 })
hi("lualine_c_insert", { fg = palette.fg, bg = palette.bg })
hi("lualine_x_insert", { fg = palette.fg, bg = palette.bg })
hi("lualine_y_insert", { fg = palette.fg, bg = palette.color0 })
hi("lualine_z_insert", { fg = palette.bg, bg = palette.color2, bold = true })
hi("lualine_a_visual", { fg = palette.bg, bg = palette.color4, bold = true })
hi("lualine_b_visual", { fg = palette.fg, bg = palette.color0 })
hi("lualine_c_visual", { fg = palette.fg, bg = palette.bg })
hi("lualine_x_visual", { fg = palette.fg, bg = palette.bg })
hi("lualine_y_visual", { fg = palette.fg, bg = palette.color0 })
hi("lualine_z_visual", { fg = palette.bg, bg = palette.color4, bold = true })
hi("lualine_a_replace", { fg = palette.bg, bg = palette.color13, bold = true })
hi("lualine_b_replace", { fg = palette.fg, bg = palette.color0 })
hi("lualine_c_replace", { fg = palette.fg, bg = palette.bg })
hi("lualine_x_replace", { fg = palette.fg, bg = palette.bg })
hi("lualine_y_replace", { fg = palette.fg, bg = palette.color0 })
hi("lualine_z_replace", { fg = palette.bg, bg = palette.color13, bold = true })
hi("lualine_a_command", { fg = palette.bg, bg = palette.color5, bold = true })
hi("lualine_b_command", { fg = palette.fg, bg = palette.color0 })
hi("lualine_c_command", { fg = palette.fg, bg = palette.bg })
hi("lualine_x_command", { fg = palette.fg, bg = palette.bg })
hi("lualine_y_command", { fg = palette.fg, bg = palette.color0 })
hi("lualine_z_command", { fg = palette.bg, bg = palette.color5, bold = true })
hi("lualine_a_inactive", { fg = palette.color8, bg = palette.color0, bold = true })
hi("lualine_b_inactive", { fg = palette.color8, bg = palette.color0 })
hi("lualine_c_inactive", { fg = palette.color8, bg = palette.bg })
hi("lualine_x_inactive", { fg = palette.color8, bg = palette.bg })
hi("lualine_y_inactive", { fg = palette.color8, bg = palette.color0 })
hi("lualine_z_inactive", { fg = palette.color8, bg = palette.color0, bold = true })
